  ...
  return (
    <fieldset aria-invalid={!!error} aria-describedby={error ? errorId : undefined}>
      <legend className="block text-sm font-medium text-brand-dark mb-2">
        Pet Species <span className="text-red-700" aria-label="required">*</span>
      </legend>
      <div className="flex gap-4">
        ...
        >
          <input
            ...
            disabled={disabled}
            className="h-4 w-4 border-gray-300 text-brand-primary focus:ring-2 focus:ring-brand-primary/30 focus:ring-offset-2"
          />
