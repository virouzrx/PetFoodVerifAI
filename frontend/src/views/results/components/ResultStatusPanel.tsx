    ...
    return (
      ...
      >
        ...
        <div className="mt-6 flex gap-3">
          <a
            href="/analyze"
            className="rounded-md bg-brand-primary px-4 py-2 text-sm font-medium text-white hover:bg-brand-primary/90 focus:outline-none focus:ring-2 focus:ring-brand-primary/30 focus:ring-offset-2"
          >
            Analyze New Product
          </a>
          <a
